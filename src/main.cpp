...
const string strMessageMagic = "ScryptBP Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // ScryptBP: 1 days
static const int64 nTargetSpacing = 600; // ScryptBP: 10 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal scryptbp miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ScryptBP", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x90b0bd6202cdfd7d8d71e6ca04424de15474fbc5fe2ea41569e581d234d5df44");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Random timestamp text";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1513175800; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1513175800;
            block.nNonce   = 617228;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x9a69c5a7d09b9a4942d6eb5c19b36581232e4777307da15541ac45d82995719b"));
